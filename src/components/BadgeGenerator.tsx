...
export default function BadgeGenerator() {
  ...
  const attendeeRangeStart =
    filteredAttendees.length === 0
      ? 0
      : (safeAttendeePage - 1) * ATTENDEES_PER_PAGE + 1;
  ...
  const getQRValueForAttendee = (attendee: Attendee) => {
    if (!configuration.qr) {
      return "";
    }
    ...
    switch (configuration.qrField) {
      ...
      case "custom": {
        const value = getCustomQRValue(attendee);

        if (!configuration.customQRField?.trim()) {
  ...
  const getQRValue = () => {
    ...
    return getQRValueForAttendee(selectedAttendee);
  };
        ...
        {attendees.length > 0 && (
          ...
          >
            ...
            <div className="overflow-hidden rounded-3xl border border-zinc-200/80 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div className="relative w-full sm:max-w-md">
                    ...
                    <input
                      ...
                      className="w-full rounded-2xl border border-zinc-200 bg-zinc-50 py-3 pl-10 pr-4 text-sm outline-none transition placeholder:text-zinc-400 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 dark:border-zinc-700 dark:bg-zinc-800"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between gap-3 sm:justify-end">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="min-w-16 text-center text-xs font-bold text-zinc-700 dark:text-zinc-200">
                        {safeAttendeePage} / {totalAttendeePages}
                      </span>
                      <button
                        type="button"
              ...
              {filteredAttendees.length > 0 ? (
                <AttendeeTable attendees={paginatedAttendees} />
              ) : (
